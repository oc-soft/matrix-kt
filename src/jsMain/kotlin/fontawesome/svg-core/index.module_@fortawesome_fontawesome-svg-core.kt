...
external var dom: DOM

external var library: Library

external object parse {
    fun transform(transformString: String): Transform
}
...
external interface AbstractElement {
    var tag: String
    var attributes: Any
    var children: Array<AbstractElement>?
        get() = definedExternally
        set(value) = definedExternally
}
...
external interface Attributes {
    @nativeGetter
    operator fun get(key: String): dynamic /* Number? | String? */
    @nativeSetter
...
external interface Params {
    var title: String?
        get() = definedExternally
        set(value) = definedExternally
    var classes: dynamic /* String? | Array<String>? */
        get() = definedExternally
        set(value) = definedExternally
...
external interface IconParams : Params {
    var transform: Transform?
        get() = definedExternally
        set(value) = definedExternally
    var symbol: dynamic /* String? | Boolean? */
        get() = definedExternally
        set(value) = definedExternally
    var mask: IconLookup?
        get() = definedExternally
...
external interface DOM {
    fun i2svg(params: `T$0` = definedExternally): Promise<Unit>
    fun css(): String
...
external interface Library {
    fun add(vararg definitions: Any /* IconDefinition | IconPack */)
    fun reset()
}
