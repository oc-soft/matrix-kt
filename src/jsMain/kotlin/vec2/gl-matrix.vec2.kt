...
external fun fromValues(x: Number, y: Number): GLM.IArray = definedExternally
external fun copy(out: GLM.IArray, a: GLM.IArray): GLM.IArray = definedExternally
external fun set(out: GLM.IArray, x: Number, y: Number): GLM.IArray = definedExternally
...
external fun transformMat2(out: GLM.IArray, a: GLM.IArray, m: GLM.IArray): GLM.IArray = definedExternally
external fun transformMat2d(out: GLM.IArray, a: GLM.IArray, m: GLM.IArray): GLM.IArray = definedExternally
...
external fun forEach(a: GLM.IArray, stride: Number, offset: Number, count: Number, fn: (a: GLM.IArray, b: GLM.IArray, arg: Any) -> Unit, arg: Any): GLM.IArray = definedExternally
external fun forEach(a: GLM.IArray, stride: Number, offset: Number, count: Number, fn: (a: GLM.IArray, b: GLM.IArray) -> Unit): GLM.IArray = definedExternally
